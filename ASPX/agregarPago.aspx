...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <section class="fondo">
        ...
        <ul class="ulPago">
            ...
            <li>Cantidad de Dispositivos <br> <asp:TextBox ID="txtCantDisp" runat="server"></asp:TextBox></li>
            <li>Servicio: <br> <div class="cajaSelect"><asp:DropDownList ID="dropServicio" runat="server" DataSourceID="SqlDropServicio" DataTextField="nombre" DataValueField="cod_servicio"></asp:DropDownList>
